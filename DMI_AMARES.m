function DMIResults=DMI_AMARES(inputfids,Parameters,xaxis,waterloc)
defaultfolder=cd;
AMARESfolder='C:\Users\agursan.DS\surfdrive\Deuterium_CSI\Matlab_codes\AMARESforDMI\+AMARES';
...
% pk = PK_2H_7T_LiverDMIVoigthard;disp('Voigt lineshapes with hard constraints.') % Which prior knowledge will be used is to be decided
% pk = PK_2H_7T_LiverDMI_lorentzian;disp('Lorentzian lineshapes.') % Which prior knowledge will be used is to be decided
% pk = PK_2H_7T_LiverDMIEPSI;disp('Prior knowledge for EPSI.') % Which prior knowledge will be used is to be decided
pk = PK_2H_7T_LiverNatAbun;disp('Natural abundance signal.') % Which prior knowledge will be used is to be decided
