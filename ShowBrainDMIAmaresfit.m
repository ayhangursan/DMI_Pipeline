function ShowBrainDMIAmaresfit(inputspec,DMIResults,row,col,slice,xaxis,Parameters,Referenceloc)
...
legend1=legend('Raw data','Fitted spectrum','Residual','Lipid','Glx','Glucose','Water','FontSize',24);
