function DMIResults=BrainDMI_AMARES(inputfids,Parameters,xaxis,waterloc)
defaultfolder=cd;
...
pk = PK_2H_7T_BrainDMI_lorentzian;disp('Lorantzian lineshapes in Brain.') % Which prior knowledge will be used is to be decided
